...
async def play(_, message: Message):
    ...
    if audio:
        ...
        title = file_name
        thumb_name = "https://te.legra.ph/file/5e3c7aef33003ba82d358.jpg"
            ...
            [
                [
                        InlineKeyboardButton(
                            ...
                            url=f"https://t.me/purpleplaneteer")
    ...
    if int(chat_id) in ACTV_CALLS:
        ...
        await message.reply_photo(
            photo="final.png",
            caption="**🔮𝑷𝒖𝒓𝒑𝒍𝒆 𝑷𝒍𝒂𝒏𝒆𝒕🤞Ʌɗɗɘɗ 💿 Søɳʛ❗️\n🔊 Ʌʈ 💞 Ƥøsɩʈɩøɳ » `{}` 🌷 ...**".format(position),
        ...
        await message.reply_photo(
            photo="final.png",
            reply_markup=keyboard,
            caption="**🔮𝑷𝒖𝒓𝒑𝒍𝒆 𝑷𝒍𝒂𝒏𝒆𝒕🤞𝑴𝒖𝒔𝒊𝒄 🎸 𝑵𝒐𝒘 💞\n🔊 Ƥɭɑyɩɳʛ 😍 ØƤ 🥀 ...**".format(),
        )
...
async def pause(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://te.legra.ph/file/5e3c7aef33003ba82d358.jpg", 
                             caption="**🔮𝑷𝒖𝒓𝒑𝒍𝒆 𝑷𝒍𝒂𝒏𝒆𝒕 🔈 𝑴𝒖𝒔𝒊𝒄🤞𝑵𝒐𝒘 🥀\n▶️ Ƥɑʋsɘɗ 🌷 ...**"
    )
...
async def resume(_, message: Message):
    ...
    await message.reply_photo(
                             photo="https://te.legra.ph/file/5e3c7aef33003ba82d358.jpgg", 
                             caption="**🔮𝑷𝒖𝒓𝒑𝒍𝒆 𝑷𝒍𝒂𝒏𝒆𝒕 🔈 𝑴𝒖𝒔𝒊𝒄🤞𝑵𝒐𝒘 🥀\n⏸ Ƥɭɑyɩɳʛ 🌷 ...**"
    )
...
async def skip(_, message: Message):
    ...
    if int(chat_id) not in ACTV_CALLS:
        await message.reply_text("**🔮𝑷𝒖𝒓𝒑𝒍𝒆 𝑷𝒍𝒂𝒏𝒆𝒕 💞 Ɲøʈɦɩɳʛ 🔇\n🚫 Ƥɭɑyɩɳʛ 🌷 ...**")
    else:
    ...
    await message.reply_photo(
                             photo="https://te.legra.ph/file/5e3c7aef33003ba82d358.jpg", 
                             caption=f'**🔮𝑷𝒖𝒓𝒑𝒍𝒆 𝑷𝒍𝒂𝒏𝒆𝒕 🔈 𝑴𝒖𝒔𝒊𝒄🤞𝑵𝒐𝒘 🥀\n⏩ Sƙɩƥƥɘɗ 🌷 ...**'
   ) 
